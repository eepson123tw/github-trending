...
export const translations = {
  "zh-TW": {
    ...
    insight7Title: "{{noisePercent}}% 都是浮雲",
    insight7Desc: "只有 {{evergreenPercent}}% 的 repo 能持續上榜超過 16 天，近 {{noisePercent}}% 在 5 天內就消失 — Trending 的「噪音」極高。",
    insight8Title: "Microsoft 是隱藏冠軍",
    insight8Desc: "{{msRepos}} 個 repo、{{msAppearances}} 次上榜，Microsoft 是 GitHub Trending 上最活躍的組織，主力集中在 AI Agent 領域。",
    ...
    // Guess Game
    guessTitle: "你猜猜看",
    guessDesc: "測測你對開源趨勢的直覺 — 畫出你認為的走勢",
    guessPrompt: "畫出 AI Agent 這一年的趨勢走勢",
    guessDraw: "在圖表上拖曳畫線",
    guessReveal: "揭曉答案",
    guessReset: "再玩一次",
    guessAccuracy: "直覺準確度",
    guessQ2: "你覺得一個 repo 平均能上榜幾天？",
    guessQ3: "哪個分類成長最快？",
    guessCorrect: "答對了！",
    guessWrong: "不是喔！答案是",
    guessNext: "下一題",
    ...
    // Racing Chart
    racingTitle: "時間賽跑",
    racingDesc: "{{days}} 天濃縮在一分鐘內 — 看各分類如何此消彼長",
    racingPlay: "播放",
    racingPause: "暫停",
    racingSpeed: "速度",
    navRacing: "賽跑",
    ...
    // On This Day
    otdTitle: "那天在紅什麼？",
    otdDesc: "選一個日期，看看那天 GitHub 上最紅的 Repo",
    otdToday: "今天",
    otdRandom: "隨機一天",
    otdNoData: "這天沒有資料",
    otdReposCount: "個 Repo 上榜",
    navOnThisDay: "日曆",
  ...
  en: {
    ...
    insight7Title: "{{noisePercent}}% Are Just Noise",
    insight7Desc: "Only {{evergreenPercent}}% of repos stay on trending for 16+ days. Nearly {{noisePercent}}% vanish within 5 days — the signal-to-noise ratio is extremely low.",
    insight8Title: "Microsoft Is the Hidden Champion",
    insight8Desc: "{{msRepos}} repos, {{msAppearances}} appearances — Microsoft is the most active organization on GitHub Trending, with a heavy focus on AI Agents.",
    ...
    guessTitle: "You Guess It",
    guessDesc: "Test your instincts about open-source trends — draw what you think happened",
    guessPrompt: "Draw the AI Agent trend line over the past year",
    guessDraw: "Drag to draw on the chart",
    guessReveal: "Reveal Answer",
    guessReset: "Play Again",
    guessAccuracy: "Instinct Accuracy",
    guessQ2: "How many days does the average repo stay trending?",
    guessQ3: "Which category grew fastest?",
    guessCorrect: "Correct!",
    guessWrong: "Nope! The answer is",
    guessNext: "Next",
    guessFinish: "Done",
    guessScore: "Your Score",
    navGuess: "Quiz",

    racingTitle: "Time Race",
    racingDesc: "{{days}} days compressed into one minute — watch categories rise and fall in real time",
    racingPlay: "Play",
    racingPause: "Pause",
    racingSpeed: "Speed",
    navRacing: "Race",

    otdTitle: "What Was Trending?",
    otdDesc: "Pick a date and see what was hot on GitHub that day",
    otdToday: "Today",
    otdRandom: "Random Day",
    otdNoData: "No data for this date",
    otdReposCount: "repos trending",
    navOnThisDay: "Calendar",
  ...
  "zh-CN": {
    ...
    insight7Title: "{{noisePercent}}% 都是浮云",
    insight7Desc: "只有 {{evergreenPercent}}% 的 repo 能持续上榜超过 16 天，近 {{noisePercent}}% 在 5 天内就消失 — Trending 的「噪音」极高。",
    insight8Title: "Microsoft 是隐藏冠军",
    insight8Desc: "{{msRepos}} 个 repo、{{msAppearances}} 次上榜，Microsoft 是 GitHub Trending 上最活跃的组织，主力集中在 AI Agent 领域。",
    ...
    guessTitle: "你猜猜看",
    guessDesc: "测测你对开源趋势的直觉 — 画出你认为的走势",
    guessPrompt: "画出 AI Agent 这一年的趋势走势",
    guessDraw: "在图表上拖拽画线",
    guessReveal: "揭晓答案",
    guessReset: "再玩一次",
    guessAccuracy: "直觉准确度",
    guessQ2: "你觉得一个 repo 平均能上榜几天？",
    guessQ3: "哪个分类成长最快？",
    guessCorrect: "答对了！",
    guessWrong: "不是哦！答案是",
    guessNext: "下一题",
    ...
    racingTitle: "时间赛跑",
    racingDesc: "{{days}} 天浓缩在一分钟内 — 看各分类如何此消彼长",
    racingPlay: "播放",
    racingPause: "暂停",
    racingSpeed: "速度",
    navRacing: "赛跑",
    ...
    otdTitle: "那天在红什么？",
    otdDesc: "选一个日期，看看那天 GitHub 上最红的 Repo",
    otdToday: "今天",
    otdRandom: "随机一天",
    otdNoData: "这天没有数据",
    otdReposCount: "个 Repo 上榜",
    navOnThisDay: "日历",
