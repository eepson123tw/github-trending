...
export const translations = {
  "zh-TW": {
    ...
    // Racing Chart
    racingTitle: "時間賽跑",
    racingDesc: "354 天濃縮在一分鐘內 — 看各分類如何此消彼長",
    racingPlay: "播放",
    racingPause: "暫停",
    racingSpeed: "速度",
    navRacing: "賽跑",
  ...
  en: {
    ...
    racingDesc: "354 days compressed into one minute — watch categories rise and fall in real time",
    racingPlay: "Play",
    racingPause: "Pause",
    racingSpeed: "Speed",
    navRacing: "Race",
  ...
  "zh-CN": {
    ...
    racingTitle: "时间赛跑",
    racingDesc: "354 天浓缩在一分钟内 — 看各分类如何此消彼长",
    racingPlay: "播放",
    racingPause: "暂停",
    racingSpeed: "速度",
    navRacing: "赛跑",
